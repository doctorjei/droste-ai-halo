# SOURCE (Fedora) — reference for the Debian/gemet port of ds4. DO NOT BUILD; port target = rocm/ds4-artifacts + rocm/ds4-runtime.
# build stage
...
# ds4 (multi-node branch with split-model memory allocation fix)
WORKDIR /opt/ds4
ARG REPO=https://github.com/kyuz0/ds4.git
ARG BRANCH=rocm-multi-node
